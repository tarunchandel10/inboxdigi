...
function DashboardTable({ data, onDateChange, clearFilter, onCloneCampaign, onSearch ,  isFilterSelected}) {
                                            ...
                                            <tr key={item.id}>
                                                ...
                                                <td>
                                                    ...
                                                    >
                                                        ...
                                                        {/* <Dropdown.Item eventKey="4" className="p-md-3"  onClick={() => handleViewCampaign(item)}>
                                                        <Image
                                                        src="/images/camp.svg"
                                                        width={19}
                                                        height={18}
