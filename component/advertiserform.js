                            ...
                            <div className={`${FormCss.feilds_box}`}>
                                ...
                                <div className={`${FormCss.form_feilds}`}>
                                    ...
                                    <div className="position-relative">
                                        ...
                                        <input type="number" id="plannedSpend" name="plannedSpend" className={errors.plannedSpend ? "border-danger" : ""} placeholder="645" value={plannedSpend} onChange={(e) => setplannedSpend(e.target.value)} />
                                    </div>
