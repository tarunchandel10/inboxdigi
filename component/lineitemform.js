            ...
            <div className={`${FormCss.top_bar}`}>
                <div className={`${FormCss.container} container`}>
                    <div className={`${FormCss.form_title}`}>
                        ...
                        <h4>{page === "editLineItem" ? "Edit Line Item" : "New Line Item"}<span> (Campaign -  Insertion Order -)</span></h4>
                    </div>
                </div>
            </div>
                                ...
                                <div className={`${FormCss.row}`}>
                                    ...
                                    <div className="col-md-6">
                                        <div className={`${FormCss.status}`}>
                                            <select className={status === 'Active' ? "bg-sucess" : "bg-light"} id="status" name="status" value={status} onChange={(e) => setstatus(e.target.value)}>
                                                ...
                                                <div className={`${FormCss.radio_data}`}>
                                                    ...
                                                    <div className={`${FormCss.radio_btn}`}>
                                                        ...
                                                        <label htmlFor="Impressions" className="cr">
                                                            <input type="number" name="impressionVal" id="impressionVal" placeholder="0" className={`${FormCss.setWidth}`} value={PacingTypeValue} onChange={(e) => setPacingTypeValue(e.target.value)} /> Impressions</label>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
