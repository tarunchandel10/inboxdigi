...
export default function InsertionForm({ page }) {
    ...
    const [insertionStatus, setinsertionStatus] = useState("draft");
        ...
        const fetchData = async () => {
            try {
                ...
                if (token && insertion_id) {
                    ...
                    setinsertionStatus(dataVal.status)
                                            ...
                                            <div className={`${FormCss.form_feilds}`}>
                                                ...
                                                <div className='position-relative'>
                                                    {budgetSelect === "Amount" ?
                                                        ...
                                                        : ""}
                                                    <input type="number" name="budget" id="budget" placeholder="2,694,680" value={segment.amount} onChange={(e) => handleSegmentChange(index, 'amount', e.target.value)} />
                                                </div>
                                            </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className={pacingType === 'Flight' ? "col-md-4" : "col-md-8"}>
                                            <div className={`${FormCss.select_pacing}`}>
                                                ...
                                                {pacingType === "Daily" ? <input type="number" name="number" id="number" value={dailyCost} placeholder="0" onChange={(e) => setDailyCost(e.target.value)} /> : ""}
                                            </div>
                                        </div>
                                    ...
                                    <div className={`${FormCss.radio_options}`}>
                                        ...
                                        {optimiseType === "Automate_bid_budget_at_insertion_order_level" ?
                                            <div className={`${FormCss.radio_data}`}>
                                                ...
                                                <div className="input_group_prepend">
                                                    <p>₹</p>
                                                </div> <input type="number" name="impression" id="impression" placeholder="20" value={additionalOptionType ? additionalOptionPrice : ""} onChange={(e) => setadditionalOptionPrice(e.target.value)} /> </div></label>
                                                            </div>
                                                            <div className={`${FormCss.checkboxs}`}>
                                ...
                                <div className={`${FormCss.form_feilds}`}>
                                    ...
                                    <div className={`${FormCss.radio_feilds}`}>
                                        ...
                                        <div className={`${FormCss.radio_btn}`}>
                                            ...
                                            {frequencyCap == "no Limit" ? "" : <><input className={`${FormCss.radio_input}`} type="number" name="LimitFrequency" value={limit} id="LimitFrequency" onChange={(e) => setLimit(e.target.value)} />
                                        ...
                                        <>
                                            <div className="data-get d-block">
                                                <p className="d-flex">
                                                    ...
                                                    {demographicData.age ? <p className='mb-0'><b>Age :</b> {demographicData.age.join(', ')} , </p> : ""}
                                                    {demographicData.ageRange ? <p className='mb-0'><b>Age Range: </b>   {demographicData.ageRange} , </p> : ""}
                                                    {demographicData.income ? <p className='mb-0'><b>Income: </b>    {demographicData.income.join(', ')} , </p> : ""}
                                                    {demographicData.incomeRange ? <p className='mb-0'><b>Income Range:</b>    {demographicData.incomeRange} , </p> : ""}
                                                    {demographicData.parentalStatus ? <p className='mb-0'><b>Parental Status: </b>     {demographicData.parentalStatus.join(', ')}</p> : ""}
                                                </p>
                                            </div>
                                        </>
                                        : ""}
