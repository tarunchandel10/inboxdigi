...
function CreativeMain({ data, page, onSelectItems }) {
              ...
              <div className="col-12">
                <div className="table_top">
                  <div className="dropdown-basic-creative">
                    <DropdownButton id="dropdown-basic-button" className="dropdown-basic-creative" title="New " onClick={() => setShowOverlay(true)}>
                      <Dropdown.Item>
                        <Dropdown onMouseLeave={() => setShowUploadDropdown(false)} onMouseOver={() => setShowUploadDropdown(true)} drop="end">
