...
function DashboardScreen({campaignsData,data,onDateChange ,clearAllFilter,onCloneCampaign,onSearch,isFilterSelected }) {
  return (
        <>
        <section className="main">
            ...
            <DashboardTable  data ={campaignsData} onDateChange={onDateChange} clearFilter={clearAllFilter}  onCloneCampaign={onCloneCampaign} onSearch={onSearch}   isFilterSelected={isFilterSelected}/>
        </section>
            </>
 );
}
