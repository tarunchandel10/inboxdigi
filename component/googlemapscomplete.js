    ...
    <div className='container'>
      <div className='row'>
        <div className='col-5'>
          ...
          <div>
            <label htmlFor="radius">Radius: {radiusMiles} miles</label>
            <input
              id="radius"
              type="range"
              min="3"
                 ...
                 <div className={`${FormCss.languages_btns}`}>
                    <Button
                      ...
                      className={`include_btn ${
                        includedLocations.find(loc => loc.name === address) ? 'clicked-btn' : ''
                      } `}
                    >
                      <CheckCircle />
                    </Button>
                    <Button
                      ...
                      className={`exclude_btn ${
                        excludedLocations.find(loc => loc.name === address) ? 'clicked-btn' : ''
                      }`}
                    >
                      <SlashCircle />
                    </Button>
        ...
        <div className='col-7 position-relative'>
          {isLoaded && (
            ...
            >
              ...
              {selectedAddress && ( 
                <Marker position={selectedAddress} icon={redMarkerIcon} />
              )}
              {!disableRadiusInput && ( 
                <Circle
                  center={center}
