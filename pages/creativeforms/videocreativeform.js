                                                ...
                                                <div className={`${FormCss.form_feilds}`}>
                                                    ...
                                                    <div className={`${FormCss.form_contant}`}>
                                                        <div className={`${FormCss.form_contant_feilds}`}>
                                                            ...
                                                            <input type="number" id="seconds" placeholder="5" value={video_skip_offset_seconds} onChange={(e) => setVideoSkipOffsetSeconds(e.target.value)} />
                                                        ...
                                                        <div className={`${FormCss.form_contant_feilds}`}>
                                                            ...
                                                            <input type="number" id="percent" placeholder="50" value={video_skip_offset_per} onChange={(e) => setVideoSkipOffsetPer(e.target.value)} />
                                                            <div className={`${FormCss.input_group_prepend}`}>
                                                                <p>%</p>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className={`${FormCss.form_feilds}`}>
                                                    ...
                                                    <div className={`${FormCss.form_contant}`}>
                                                        <div className={`${FormCss.form_contant_feilds}`}>
                                                            ...
                                                            <input type="number" id="seconds" placeholder="5" value={video_progress_offset_seconds} onChange={(e) => setVideoProgressOffsetSeconds(e.target.value)} />
                                                            <div className={`${FormCss.input_group_prepend}`}>
                                                                <p>Seconds</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className={`${FormCss.form_contant_feilds}`}>
                                                            ...
                                                            <input type="number" id="percent" placeholder="50" value={video_progress_offset_per} onChange={(e) => setVideoProgressOffsetPer(e.target.value)} />
                                                            <div className={`${FormCss.input_group_prepend}`}>
                                                                <p>%</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className={`${FormCss.form_feilds}`}>
                                                        <div className={`${FormCss.date_feilds}`}>
                                                            <div className={`${FormCss.date_box}`}>
                                                                ...
                                                                <input type="number" id="width" name="width" placeholder="0" value={video_width} onChange={(e) => setVideoWidth(e.target.value)} />
                                                            </div>
                                                            <p>Px</p>
                                                            <div className={`${FormCss.date_box}`}>
                                                                <label htmlFor="height">Height</label>
                                                                <input type="number" id="height" name="height" placeholder="0" value={video_hight} onChange={(e) => setVideoHeight(e.target.value)} />
                                                            </div>
                                                            <p>Px</p>
                                                            <div className={`${FormCss.date_box}`}>
